...
// calendarInstance.on('clickEvent', (event) => {
//   // Access the details of the clicked event
//   const clickedEvent = event.event;

//   // Now you can use clickedEvent to access event details
//   const eventId = clickedEvent.id;
//   const calendarId = clickedEvent.calendarId;
// });

// calendarInstance.on('beforeUpdateEvent', (eventObj) => {
//   calendarInstance.updateEvent(`event${eventCounter}`, `cal${eventCounter}`, {
//     title: e.target.event_name.value,
//     location: e.target.event_location.value, // Added location
//     attendees: e.target.event_attendees.value.split(','), // Added attendees
...
// Uncomment the following lines if you want to delete an event
// const handleDeleteEvent = () => {
//   calendarInstance.deleteEvent('event1', 'cal1');
// };

// Call the delete method when needed
// handleDeleteEvent();

// Event listener for beforeCreateSchedule
// calendarInstance.on('beforeCreateSchedule', (eventObj) => {
//   // Prevent the default behavior of the creation popup
//   eventObj.preventDefault();
// });

// Update multiple properties
// Mungkin ini bakal buat admin karena update
// calendarInstance.updateEvent('event1', 'cal1', {
//   title: 'Going vacation',
//   state: 'Free',
//   start: '2023-11-23T00:00:00',
//   end: '2023-11-23T23:59:59',
// });