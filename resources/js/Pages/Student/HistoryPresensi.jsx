  ...
  return (
    <div className="p-6">
        ...
        <div className="flex flex-col items-center">
            <h1 className="font-black text-center text-2xl text-bold border-b-2 w-1/3 border-black pb-5 mb-10">Oktober 2023</h1>
        </div>

        <table className="mt-6 w-full">
            <thead className="text-gray-500">
                <tr>
                    <th className="px-4 py-2 text-start">Nama Mata Pelajaran</th>
                    <th className="px-4 py-2">Kehadiran</th>
                    <th className="px-4 py-2 text-end">Hari & Tanggal</th>
                </tr>
            </thead>
            <tbody>
                {cards.map((card, index) => (
                    <PresensiCard key={index} {...card} />
                ))}
            </tbody>
        </table>
    </div>
