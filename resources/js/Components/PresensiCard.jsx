...
export default function PresensiCard({ content, person, date, bgColor }) {
  return (
    <tr className="w-full">
        ...
        <td className="text-center"><input type="checkbox" className="cursor-pointer h-5 w-5 text-green-600 border-gray-300 rounded-full focus:ring-green-600" /></td>
        <td className="text-end"><h3 className="font-bold mr-4">{date}</h3></td>
    </tr>
  );
}

PresensiCard.propTypes = {
